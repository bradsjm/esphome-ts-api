...
class SenseEnergyMonitor extends import_adapter_core.Adapter {
  ...
  async onReady() {
    ...
    this.parser = new import_lib.SenseParser({
    ...
    this.parser.on("gridVoltages", (voltages) => {
    ...
    this.parser.on("device", async (device) => {
