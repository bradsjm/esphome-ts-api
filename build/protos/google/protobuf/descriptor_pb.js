...
// @generated message type with reflection information, may provide speed optimized methods
class ExtensionRangeOptions_Declaration$Type extends runtime_5.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.isRepeated !== undefined)
            writer.tag(4, runtime_1.WireType.Varint).bool(message.isRepeated);
...
//# sourceMappingURL=descriptor_pb.js.map